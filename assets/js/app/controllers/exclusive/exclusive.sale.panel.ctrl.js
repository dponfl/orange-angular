(function () {
  ...
  angular
    .module('OrangeClient')
    .controller('ExclusiveSalePanelCtrl', ExclusiveSalePanelCtrl);

  ExclusiveSalePanelCtrl.$inject = ['GeneralConfigService', 'S_ReqService', '$rootScope', '$scope', '$modal', '$log',
    'lodash', 'toaster'];

  /* @ngInject */
  function ExclusiveSalePanelCtrl(GeneralConfigService, S_ReqService, $rootScope, $scope, $modal, $log,
                         lodash, toaster) {
    var _ = lodash;
    var __=GeneralConfigService;
    var vm = this;
    vm.title = 'ExclusiveSalePanelCtrl';
    vm.badge = false;

    var exclusiveSaleBookObjectModal = $modal({
      scope: $scope,
      templateUrl: '../templates/view/exclusive/exclusiveSaleBookObjectModal.html',
      show: false,
      backdrop: true,
      onHide: function () {
...
*/
    ...
    function _showBookObject() {
      ...
      exclusiveSaleBookObjectModal.$promise.then(exclusiveSaleBookObjectModal.show);
    }

    function _hideBookObject() {
      exclusiveSaleBookObjectModal.$promise.then(exclusiveSaleBookObjectModal.hide);
    }
...
*/
      ...
      vm.formData.deal_type = 'exclusive_sale';
