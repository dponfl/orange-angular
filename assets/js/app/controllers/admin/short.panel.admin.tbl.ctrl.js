(function () {
  ...
  angular
    .module('OrangeClient')
    .controller('ShortPanelAdminTblCtrl', ShortPanelAdminTblCtrl);

  ShortPanelAdminTblCtrl.$inject = ['GeneralConfigService', 'EditObjectService', '$rootScope',
    '$scope', '$log','lodash'];

  /* @ngInject */
  function ShortPanelAdminTblCtrl(GeneralConfigService, EditObjectService, $rootScope,
                             $scope, $log, lodash) {
    var _ = lodash;
    var __=GeneralConfigService;
    var vm = this;
    vm.title = 'ShortPanelAdminTblCtrl';
