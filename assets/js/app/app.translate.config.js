...
function translateConfig ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'LBL_CONTACT_FORM_OFFICE_MOBILE_1': 'Mob',
  ...
  $translateProvider.translations('ru', {
    ...
    'OBJ_PRICE_PLACEHOLDER': 'Введите стоимость',
    'OBJ_PRICE_PLACEHOLDER_SHORT': 'Пример: Период-1 : Стоимость-1 ; Период-2 : Стоимость-2',
    ...
    'OBJ_QA_Q_PLACEHOLDER': 'Введите текст вопроса',
    'OBJ_QA_A_PLACEHOLDER': 'Введите текст ответа',
    'BTN_FIND': 'Найти',
    'BTN_CLR': 'Очистить',
    'AV_REQ': 'reqRu',
