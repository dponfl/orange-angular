...
function translateConfig ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'HEADER_INFO_LET': 'Let property information request',
    'HEADER_INFO_BUY': 'Buy property information request',
    'HEADER_INFO_SELL': 'Sell property information request',
  ...
  $translateProvider.translations('ru', {
    ...
    'HEADER_INFO_LET': 'Запрос информации по сдаче недвижимости в аренду',
    'HEADER_INFO_BUY': 'Запрос информации по покупке недвижимости',
    'HEADER_INFO_SELL': 'Запрос информации по продаже недвижимости',
