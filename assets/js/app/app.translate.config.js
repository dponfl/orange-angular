...
function translateConfig ($translateProvider) {
  ...
  $translateProvider.translations('ru', {
    ...
    'LBL_HOME_TITLE': 'Главная страница: Заголовок',
    'OBJ_HOME_TITLE_PLACEHOLDER': 'Главная страница: Заголовок',
    'LBL_HOME_BODY_LEAD': 'Главная страница: Ведущий параграф',
    'OBJ_HOME_BODY_LEAD_PLACEHOLDER': 'Главная страница: Ведущий параграф',
    'LBL_HOME_BODY_P_1': 'Главная страница: 1-ый параграф',
    'OBJ_HOME_BODY_P_1_PLACEHOLDER': 'Главная страница: 1-ый параграф',
    'LBL_HOME_BODY_P_2': 'Главная страница: 2-ой параграф',
    'OBJ_HOME_BODY_P_2_PLACEHOLDER': 'Главная страница: 2-ой параграф',
    'LBL_HOME_BODY_P_3': 'Главная страница: 3-ий параграф',
    'OBJ_HOME_BODY_P_3_PLACEHOLDER': 'Главная страница: 3-ий параграф',
    'LBL_HOME_EXCLUSIVE_TITLE': 'Главная страница, эксклюзивные объекты: Заголовок',
    'OBJ_HOME_EXCLUSIVE_TITLE_PLACEHOLDER': 'Главная страница, эксклюзивные объекты: Заголовок',
    'LBL_HOME_EXCLUSIVE_H1': 'Главная страница, эксклюзивные объекты: Подзаголовок 1',
    'OBJ_HOME_EXCLUSIVE_H1_PLACEHOLDER': 'Главная страница, эксклюзивные объекты: Подзаголовок 1',
    'LBL_HOME_EXCLUSIVE_H2': 'Главная страница, эксклюзивные объекты: Подзаголовок 2',
    'OBJ_HOME_EXCLUSIVE_H2_PLACEHOLDER': 'Главная страница, эксклюзивные объекты: Подзаголовок 2',
    'LBL_HOME_EXCLUSIVE_MORE': 'Главная страница, эксклюзивные объекты: Кнопка',
    'OBJ_HOME_EXCLUSIVE_MORE_PLACEHOLDER': 'Главная страница, эксклюзивные объекты: Кнопка',
